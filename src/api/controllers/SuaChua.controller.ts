import { SuaChua } from '@/api/schemas/SuaChua.schema'
import * as service from '@/api/services/SuaChua.service'
import { RequestBodyType } from '@/type'
import { NextFunction, Request, Response } from 'express'

const NAMESPACE = 'controllers/sua-chua'

export const createNewItem = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const dataRequest: SuaChua = {
      ...req.body
    }
